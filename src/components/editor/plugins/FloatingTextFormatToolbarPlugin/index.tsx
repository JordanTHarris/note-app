...
function TextFormatFloatingToolbar({
  ...
  return (
    ...
    <div
      ...
      className="absolute left-0 top-0 z-10 flex items-center gap-1 rounded-md border bg-background p-1 opacity-0 transition-opacity duration-300"
    >
      {editor.isEditable() && (
        <>
          <Button
          ...
          <Button
            ...
            className={cn(
              "h-7 w-7 text-muted-foreground",
              isSubscript && "bg-secondary text-foreground",
            )}
            title="Subscript"
          ...
          <Button
            ...
            className={cn(
              "h-7 w-7 text-muted-foreground",
              isSuperscript && "bg-secondary text-foreground",
            )}
            title="Superscript"
