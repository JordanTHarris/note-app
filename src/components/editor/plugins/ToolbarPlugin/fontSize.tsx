  ...
  return (
    <div className="flex h-7 items-center gap-1">
      ...
      <input
        ...
        value={inputValue}
        disabled={disabled}
        className="h-5 w-5 text-center text-sm font-semibold text-foreground [appearance:textfield] disabled:opacity-50 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
