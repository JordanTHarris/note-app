  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center">
      <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
        <h1 className="animate-linear bg-gradient-to-r from-red-600 via-indigo-500 to-red-600 bg-[length:200%_auto] bg-clip-text text-center text-6xl font-extrabold leading-tight tracking-tight text-transparent sm:text-[5rem] lg:text-8xl lg:leading-tight">
          Note App
        </h1>
